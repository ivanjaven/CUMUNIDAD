...
import { columns } from '@/components/e-columns'
import { DataTable } from '@/components/e-data-table'
import { fetchPopulationList } from '@/server/queries/fetch-population-list-2'
...
export default function PopulationPage() {
  const [populationData, setPopulationData] = useState<PopulationData2[]>([])
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const validatedData = DisplayPopulationTypedef.array().parse(data)
